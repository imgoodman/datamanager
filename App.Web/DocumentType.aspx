<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DocumentType.aspx.cs" Inherits="App.Web.DocumentType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <p class="titleRow">
            <img alt="" class="NaviImage" src="Img/Add.jpg" /><b>添加文档类型</b></p>
        <br />
        <center>
            <table class="tableBorder" cellspacing="0" cellpadding="3">
                <tr>
                    ...
                    <td class="contenttd">
                        <JQPLMWeb:Category ID="category1" runat="server" GetDataStyle="DocType" AutoPostBack="true"
        ...
        <br />
        <p class="titleRow">
            <img alt="" class="NaviImage" src="Img/Manage.jpg" /><b>管理文档类型</b></p>
        <br />
        <center>
            <table width="80%">
                <tr>
                    <td align="left">
                        <asp:Button ID="btnDel" runat="server" Text="删 除" OnClick="btnDel_Click" Width="80px"
                            OnClientClick="return confirm('确定要删除选定文档类型？');" />
                    </td>
                    <td>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="80%" DataKeyNames="ID" OnRowCommand="GridView1_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="父级类型" DataField="FatherTypeName" />
                    <asp:BoundField HeaderText="文档类型名称" DataField="TypeName" />
    ...
    <asp:Panel ID="Panel2" runat="server" Visible="false">
        <p class="titleRow">
            <img alt="" class="NaviImage" src="Img/Edit.jpg" /><b>修改文档类型信息</b></p>
        <br />
        <center>
            <table class="tableBorder" cellspacing="0" cellpadding="3">
                <tr>
                    ...
                    <td class="contenttd">
                        <JQPLMWeb:Category ID="category2" runat="server" GetDataStyle="DocType" AutoPostBack="true"
