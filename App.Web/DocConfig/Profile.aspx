<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Profile.aspx.cs" Inherits="App.Web.DocConfig.Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="formContent">
        ...
        <p class="message warning hidden">
            ...
            <strong>Hey!</strong></p>
        <fieldset class="form detailinfo relative" id="basicinfo">
            ...
            <div class="listattr">
                <div class="attritem itemtemp hidden relative">
                    ...
                    <ul>
                        ...
                        <li>
                            <label>
                                是否允许重复</label><span class="isrepeat"> xxx</span> </li>
                    </ul>
                </div>
            </div>
            <div class="more">
        ...
        <div class="attritem relative">
            ...
            <div class="control_group">
                <label class="control_label">
                    是否搜索关键属性</label>
                <div class="controls" style="padding-top: 3px;">
                    <input type="radio" title="通常是单文本，日期，单人，多人属性和枚举" name="isSearch" value="true" /><span>是</span>
    ...
    <div class="result hidden">
        ...
        <p>
            您还可以继续新增文档,<a href="/DocConfig/Add.aspx">新增文档对象</a></p>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
                ...
                success: function (res) {
                    if (res != null) {
                        ...
                        $.each(res.Attrs, function (i, item) {
                            ...
                            $temp.find(".isrepeat").text(showBool(item.IsRepeat));
                ...
                $div.dialog({
                    ...
                    buttons: {
                        "确认": function () {
                            $.ajax({
                                type: "POST",
                                url: "/handlers/docConfig/DisableDoc.ashx",
            ...
            $(".edit_doc").click(function (e) {
                e.preventDefault();
                $(".docType").hide();
                $("#uc_docTypeSel input[type=text]").val(selDocTypeName);
                $("#selDocType").val(selDocTypeID);
                $("#uc_docTypeSel").show();
                ...
                $("#basicinfo .controls").css("padding-top", "0");
                $(this).hide();
            });
            //取消编辑基本信息
            $(".cancel_doc").click(function (e) {
                ...
                $(".save_doc").hide();
                $(".edit_doc").show();
                $("#basicinfo .controls").css("padding-top", "5px");
            });
            //验证修改后的文档是否存在
            ...
            $("#docName").blur(function () {
                if ($(this).val() != "") {
                    $.ajax({
                        type: "POST",
                        url: "/handlers/docConfig/IsUpdateExist.ashx",
            ...
            $(".save_doc").click(function (e) {
                ...
                if ($("#selDocType").val() == "") {
                    InfoTip.showMessage("请选择文档类型", "warning", 6000);
                    isValid = false;
                    return false;
                }
                ...
                if (isValid) {
                    ...
                    selDocTypeName = $("#docType_div p span").text();
                    $.ajax({
                        type: "POST",
                        url: "/handlers/docConfig/UpdateDoc.ashx",
            ...
            $("body").on("click", ".attr_up", function (e) {
                ...
                if ($prev.hasClass("itemtemp")) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/handlers/docConfig/allowChangeOrder.ashx",
                        ...
                        success: function (res) {
                            if (res == "1") {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/handlers/docConfig/ChangeAttrOrder.ashx",
                ...
                $div.dialog({
                    ...
                    buttons: {
                        "确认": function () {
                            $.ajax({
                                type: "POST",
                                url: "/handlers/docConfig/deleteAttr.ashx",
            ...
            $("#form .attrname").blur(function () {
                ...
                if (attrName != "") {
                    if (attrid != "") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/handlers/docConfig/IsAttrUpdateExist.ashx",
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/handlers/docConfig/IsAttrExist.ashx",
            ...
            $("body").on("click", ".delattrval", function (e) {
                ...
                if ($(this).next().length > 0) {
                    $.ajax({
                        type: "POST",
                        url: "/handlers/docconfig/deleteAttrVal.ashx",
                        data: { id: id },
                        dataType: "json",
                        success: function (res) {
                            if (res == "1") {
            ...
            $(".attrval_add").click(function (e) {
                ...
                if (attrval != "" && attrid != "") {
                    ...
                    $("<span>").html(attrval + "<a href='#' title='删除该属性值' class='delattrval'></a>").addClass("userspan").insertBefore($pos);
                    $txt.val("");
                }
            });
            //编辑属性值
                    ...
                    buttons: {
                        "保存": function () {
                            ...
                            if (newattrval == "") {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "/handlers/docconfig/updateAttrVal.ashx",
                                    data: {
                                        id: attrvalid,
                                        attrVal: newattrval,
                                        userid: userid
                                    ...
                                    success: function (res) {
                                        if (res == "1") {
                                            $attrval.html(newattrval + "<a href='#' title='编辑该属性值' class='editattrval edit'></a><a href='#' title='删除该属性值' class='delattrval'></a><input type='hidden' value='" + attrvalid + "'>");
                                            $div.dialog("close");
            ...
            $("body").on("click", ".attr_edit", function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/handlers/docConfig/getAttrById.ashx",
                    data: { id: attrid },
                    dataType: "json",
                    success: function (res) {
                        var $div = $("#form");
                        ...
                        $div.find("input[name=isRepeat][value='" + res.IsRepeat + "']").prop("checked", true);
                        ...
                        $div.dialog({
                            ...
                            buttons: {
                                "保存": function () {
                                    ...
                                    var isrepeat = $div.find("input[name*='isRepeat']:checked").val();
                                    ...
                                    if (isValid) {
                                        $.ajax({
                                            type: "POST",
                                            url: "/handlers/docConfig/UpdateAttr.ashx",
                                            data: {
                                                docID: id,
                                                attrID: attrid,
                                                attrName: attrName,
                                            ...
                                            success: function (res) {
                                                if (res == "1") {
                                                    ...
                                                    isrepeat = (isrepeat.toString() == "true" ? true : false);
                                                    ...
                                                    $parent.find(".isrepeat").text(showBool(isrepeat));
                                                    emptyContainer($div);
                                                } else {
                                                    showMessage("更新属性失败");
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res != "-1" || res != "0") {
                                            ...
                                            //add attrval
                                            if (attrtype == "EnumVal") {
                                                $div.find(".attr_content .userspan").each(function (i, vitem) {
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "/handlers/docconfig/addattrval.ashx",
                                                        data: {
                                            ...
                                            $item.find(".isrepeat").text(showBool(isrepeat));
