...
namespace App.Web.handlers.tempdocConfig
{
    ...
    public class UpdateAttr : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var r = dcs.UpdateAttr(new Document { ID = docID, Attrs = new List<DocumentAttr>() { new DocumentAttr { ID = attrid, AttrName = attrname, AttrType = dcs.getAttrType(attrtype), IsRequired = isrequired, IsSearch = isSearch, Description = desc, LastModifier=new User{ID=userid} } } });
