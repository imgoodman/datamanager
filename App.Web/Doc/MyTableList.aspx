<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MyTableList.aspx.cs" Inherits="App.Web.Doc.MyTableList" %>
...
<div class="header relative">
        <h1 class="pagetitle">
            列表</h1>
        <a href="/Doc/MyList.aspx" class="btn abs">列表视图</a>
    </div>
    <div id="search_div">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".header a").attr({ "href": "/Doc/MyList.aspx?ID=" + docid });
            uid = $("#userid").val();
            $.ajax({
                type: "post",
            ...
            $(".search").click(function (e) {
                ...
                if (searchAttrIds == "") {
                    ...
                    getTotal(searchAttrIds+"$0", searchAttrVals+"$"+uid,docid);
                    searchMore(pageIndex, docid);
                }                
            });
        });
